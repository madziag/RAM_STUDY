...
incidence_all<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_pooled.rds"))
setnames(incidence_all, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

incidence_age_group_2099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_12-20.99_age_group_pooled.rds"))
setnames(incidence_age_group_2099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
incidence_age_group_3099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_21-30.99_age_group_pooled.rds"))
setnames(incidence_age_group_3099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
incidence_age_group_4099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_31-40.99_age_group_pooled.rds"))
setnames(incidence_age_group_4099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
incidence_age_group_5599<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_41-55.99_age_group_pooled.rds"))
setnames(incidence_age_group_5599, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

incidence_indication_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_acne_indication_group_pooled.rds"))
setnames(incidence_indication_acne, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
incidence_indication_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_dermatitis_indication_group_pooled.rds"))
setnames(incidence_indication_derm, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
incidence_indication_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_incidence_counts_psoriasis_indication_group_pooled.rds"))
setnames(incidence_indication_psor, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### OBJECTIVE 1: PREVALENCE ###

prevalence_all<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_pooled.rds"))
setnames(prevalence_all, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

prevalence_age_group_2099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_12-20.99_age_group_pooled.rds"))
setnames(prevalence_age_group_2099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
prevalence_age_group_3099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_21-30.99_age_group_pooled.rds"))
setnames(prevalence_age_group_3099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
prevalence_age_group_4099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_31-40.99_age_group_pooled.rds"))
setnames(prevalence_age_group_4099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
prevalence_age_group_5599<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_41-55.99_age_group_pooled.rds"))
setnames(prevalence_age_group_5599, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

prevalence_indication_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_acne_indication_group_pooled.rds"))
setnames(prevalence_indication_acne, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
prevalence_indication_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_dermatitis_indication_group_pooled.rds"))
setnames(prevalence_indication_derm, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
prevalence_indication_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_prevalence_counts_psoriasis_indication_group_pooled.rds"))
setnames(prevalence_indication_psor, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### OBJECTIVE 2: DISCONTINUED ###

discontinued_all<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_pooled.rds"))
setnames(discontinued_all, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

discontinued_age_group_2099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_12-20.99_age_group_pooled.rds"))
setnames(discontinued_age_group_2099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
discontinued_age_group_3099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_21-30.99_age_group_pooled.rds"))
setnames(discontinued_age_group_3099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
discontinued_age_group_4099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_31-40.99_age_group_pooled.rds"))
setnames(discontinued_age_group_4099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
discontinued_age_group_5599<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_41-55.99_age_group_pooled.rds"))
setnames(discontinued_age_group_5599, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

discontinued_indication_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_acne_indication_group_pooled.rds"))
setnames(discontinued_indication_acne, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
discontinued_indication_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_dermatitis_indication_group_pooled.rds"))
setnames(discontinued_indication_derm, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
discontinued_indication_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_discontinued_counts_psoriasis_indication_group_pooled.rds"))
setnames(discontinued_indication_psor, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### OBJECTIVE 2: SWITCHERS ###

switcher_1<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_1_counts_pooled.rds"))
setnames(switcher_1, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
switcher_2<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_2_counts_pooled.rds"))
setnames(switcher_2, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

switcher_age_group_2099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_counts_12-20.99_age_group_pooled.rds"))
setnames(switcher_age_group_2099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
switcher_age_group_3099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_counts_21-30.99_age_group_pooled.rds"))
setnames(switcher_age_group_3099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
switcher_age_group_4099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_counts_31-40.99_age_group_pooled.rds"))
setnames(switcher_age_group_4099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
switcher_age_group_5599<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_counts_41-55.99_age_group_pooled.rds"))
setnames(switcher_age_group_5599, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

switcher_indication_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_counts_acne_indication_group_pooled.rds"))
setnames(switcher_indication_acne, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
switcher_indication_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_counts_dermatitis_indication_group_pooled.rds"))
setnames(switcher_indication_derm, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
switcher_indication_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_switcher_counts_psoriasis_indication_group_pooled.rds"))
setnames(switcher_indication_psor, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### OBJECTIVE 3: GENERAL CONCOMITANCE ###
genconcomit_all_records<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_generalconcomit_RECORDS_counts_pooled.rds"))
setnames(genconcomit_all_records, old=c("N_all"), new=c("N"))
genconcomit_all_users<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_pooled.rds"))
setnames(genconcomit_all_users, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

genconcomit_age_group_2099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_12-20.99_age_group_pooled.rds"))
setnames(genconcomit_age_group_2099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
genconcomit_age_group_3099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_21-30.99_age_group_pooled.rds"))
setnames(genconcomit_age_group_3099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
genconcomit_age_group_4099<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_31-40.99_age_group_pooled.rds"))
setnames(genconcomit_age_group_4099, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
genconcomit_age_group_5599<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_41-55.99_age_group_pooled.rds"))
setnames(genconcomit_age_group_5599, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

genconcomit_indication_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_acne_indication_group_pooled.rds"))
setnames(genconcomit_indication_acne, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
genconcomit_indication_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_dermatitis_indication_group_pooled.rds"))
setnames(genconcomit_indication_derm, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
genconcomit_indication_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_general_concomit_USERS_counts_psoriasis_indication_group_pooled.rds"))
setnames(genconcomit_indication_psor, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### OBJECTIVE 3: CONTRAINDICATED ###
contra_all_records<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_contra_RECORDS_counts_pooled.rds"))
setnames(contra_all_records, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
contra_all_users<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_contra_USERS_counts_pooled.rds"))
setnames(contra_all_users, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

contra_indication_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_contra_USERS_counts_acne_indication_group_pooled.rds"))
setnames(contra_indication_acne, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
contra_indication_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_contra_USERS_counts_dermatitis_indication_group_pooled.rds"))
# setnames(contra_indication_derm, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
contra_indication_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_contra_USERS_counts_psoriasis_indication_group_pooled.rds"))
setnames(contra_indication_psor, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### OBJECTIVE 4: TERATOGENIC ###

teratogenic_all_records<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_teratogenic_RECORDS_counts_pooled.rds"))
setnames(teratogenic_all_records, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
teratogenic_all_users<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_teratogenic_USERS_counts_pooled.rds"))
setnames(teratogenic_all_users, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

teratogenic_indication_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_teratogenic_USERS_counts_acne_indication_group_pooled.rds"))
setnames(teratogenic_indication_acne, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
teratogenic_indication_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_teratogenic_USERS_counts_dermatitis_indication_group_pooled.rds"))
setnames(teratogenic_indication_derm, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
teratogenic_indication_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_teratogenic_USERS_counts_psoriasis_indication_group_pooled.rds"))
setnames(teratogenic_indication_psor, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### RAM COUNTS ###

RAM_records_all<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_record_counts_overall_pooled.rds"))
setnames(RAM_records_all, old=c("pre_all", "post_all"), new=c("pre", "post"))

RAM_records_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_record_counts_acne_pooled.rds"))
setnames(RAM_records_acne, old=c("pre_all", "post_all"), new=c("pre", "post"))
RAM_records_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_record_counts_dermatitis_pooled.rds"))
setnames(RAM_records_derm, old=c("pre_all", "post_all"), new=c("pre", "post"))
RAM_records_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_record_counts_psoriasis_pooled.rds"))
setnames(RAM_records_psor, old=c("pre_all", "post_all"), new=c("pre", "post"))

RAM_users_all<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_user_counts_overall_pooled.rds"))
setnames(RAM_users_all, old=c("pre_all", "post_all"), new=c("pre", "post"))

RAM_users_acne<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_user_counts_acne_pooled.rds"))
setnames(RAM_users_acne, old=c("pre_all", "post_all"), new=c("pre", "post"))
RAM_users_derm<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_user_counts_dermatitis_pooled.rds"))
setnames(RAM_users_derm, old=c("pre_all", "post_all"), new=c("pre", "post"))
RAM_users_psor<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_RAM_user_counts_psoriasis_pooled.rds"))
setnames(RAM_users_psor, old=c("pre_all", "post_all"), new=c("pre", "post"))

### RETINOID COUNTS ###
retinoid_incidence<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_Retinoid_incidence_counts_pooled.rds"))
setnames(retinoid_incidence, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
retinoid_prevalence<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_Retinoid_prevalence_counts_pooled.rds"))
setnames(retinoid_prevalence, old=c("N_all", "Freq_all"), new=c("N", "Freq"))
retinoid_discontinued<-load_if_exists(paste0(g_output_dir,"/PC_HOSP_Retinoid_discontinued_counts_pooled.rds"))
setnames(retinoid_discontinued, old=c("N_all", "Freq_all"), new=c("N", "Freq"))

### POPULATION COUNTS ### WE NEED BIFAP TO UPLOAD THIS !!!!!
# population_counts_flowchart<-load_if_exists(paste0(g_output_dir,"/baseline_tables/PC_HOSP_flowchart_baseline_tables.rds"))
...
if (length(datasets) > 0) {
  ...
  incidence_age_group_sums<-incidence_age_groups_combined[,.(age_group_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)), by = YM]
...
if (length(datasets) > 0) {
  ...
  incidence_indication_sums<-incidence_indication_combined[,.(indication_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)),by=YM]
...
if (length(datasets) > 0) {
  ...
  # sum 'N' by 'YM' across age groups
  prevalence_age_group_sums<-prevalence_age_groups_combined[,.(age_group_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)), by = YM]
...
if (length(datasets) > 0) {
  ...
  # sum 'N' by 'YM' across indications
  prevalence_indication_sums<-prevalence_indication_combined[,.(indication_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)),by=YM]
...
saveRDS(flowchart_objective1, paste0(g_output_dir,"/flowchart_PC_HOSP_objective1.rds")) 
...
if (length(datasets) > 0) {
  ...
  # sum 'N' by 'YM' across age groups
  discontinued_age_group_sums<-discontinued_age_groups_combined[,.(age_group_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)), by = YM]
...
if (length(datasets) > 0) {
  ...
  # sum 'N' by 'YM' across indications
  discontinued_indication_sums<-discontinued_indication_combined[,.(indication_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)),by=YM]
...
if (length(datasets) > 0) {
  ...
  # sum 'N' by 'YM' across age groups
  switcher_age_group_sums<-switcher_age_groups_combined[,.(age_group_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)), by = YM]
...
if (length(datasets) > 0) {
  ...
  # sum 'N' by 'YM' across age groups
  switcher_indication_sums<-switcher_indication_combined[,.(indication_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)),by=YM]
  # merge the summed age group data with switcher_all by 'YM'
...
saveRDS(flowchart_objective2, paste0(g_output_dir,"/flowchart_PC_HOSP_objective2.rds")) 
...
if (exists("genconcomit_all_users") && is.data.table(genconcomit_all_users)){
  ...
  if (length(datasets) > 0) {
    ...
    # sum 'N' by 'YM' across age groups
    genconcomit_indication_sums<-genconcomit_indication_combined[,.(indication_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)),by=YM]
    # merge the summed age group data with genconcomit_all by 'YM'
  ...
  if (length(datasets) > 0) {
    ...
    # sum 'N' by 'YM' across indications
    contra_indication_sums<-contra_indication_combined[,.(indication_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)),by=YM]
...
saveRDS(flowchart_objective3, paste0(g_output_dir,"/flowchart_PC_HOSP_objective3.rds")) 
...
if (exists("teratogenic_all_users") && is.data.table(teratogenic_all_users)){
  ...
  if (length(datasets) > 0) {
    ...
    # sum 'N' by 'YM' across indications
    teratogenic_indication_sums<-teratogenic_indication_combined[,.(indication_N_sum=sum(N,na.rm=TRUE),Freq=max(Freq)),by=YM]
...
saveRDS(flowchart_objective4, paste0(g_output_dir,"/flowchart_PC_HOSP_objective4.rds")) 
...
saveRDS(flowchart_rawRAMcounts, paste0(g_output_dir,"/flowchart_PC_HOSP_rawRAMcounts.rds")) 
...
# # saveRDS(flowchart_population_comparisons, paste0(g_output_dir,"/flowchart_PC_HOSP_population_comparisons.rds")) 