...
#############################################################################################
#############################################################################################
############# RAM Incidence, Prevalence, Discontinuation ####################################
#############################################################################################
#############################################################################################
...
# We use only RAM episodes that have occurred in patients who have used a retinoid - we need to merge this with Retinoid data
...
RAM_prevalence<-RAM_prevalence[,-c("rowID","idnum","episode.day.retinoid")]
# Reorder columns
...
# Remove any records where episode day is before first record of Retinoid use (prevalence)
RAM_discontinued<-RAM_discontinued[episode.end>=episode.day.retinoid]
# Creates year and month columns
