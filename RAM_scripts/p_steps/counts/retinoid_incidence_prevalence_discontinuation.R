...
## retinoid treatment episodes - generated by retinoid_treatment_episodes.R
## study denominator -> WOCBP - counted in each month between study start and study end - generated by denominator_monthly_WOCBP.R
